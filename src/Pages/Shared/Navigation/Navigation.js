...
const Navigation = () => {
    ...
    return (
        <Box sx={{ flexGrow: 1 }}>
            ...
            <AppBar position="static" sx={{ backgroundColor: '#212121', border: 'none', boxShadow: 'none', color: 'white', overFlow: 'hidden', zIndex: 999 }}>
                <Toolbar>
                    <IconButton
                        size="large"
                        edge="start"
                        ...
                        sx={{ mr: 2 }}
                    >
                        <span style={{color:'red'}}>CAR</span> <span style={{color:'white'}}>DEALER</span>
                    </IconButton>
                    ...
                    <Link sx={{ color: 'red' }} href="/allCars" underline="none"><Button color="inherit">All Cars</Button></Link>
